...
public class ContainerFileImplTest {
  ...
  public void testPath() {
    ContainerFileImpl container_01 = new ContainerFileImpl(getClass().getClassLoader().getResource("src/test/resources/otl-2.1/01_NetwerkRuimteVoorbeeld_OTL21.ccr").getFile());
