...
public class StepDeserializer extends StdDeserializer<Step> {
  ...
  throws IOException {
    ...
    if(factory == null) {
      log.warn("Please set the static field com.sysunite.coinsweb.parser.config.StepDeserializer.factory to some instance!");
      throw new RuntimeException("Please set the static field com.sysunite.coinsweb.parser.config.StepDeserializer.factory to some instance!");
    }
